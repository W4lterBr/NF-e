...
; Última atualização: 2026-05-25 (v1.2.9)
; Notas v1.2.9:
;   - ARMAZENAMENTO: NFS-e ABRASF (_salvar_nfse_abrasf) agora salva em todos os perfis ativos.
;   - ARMAZENAMENTO: XMLs de manifestação (Ciência, Confirmação, etc.) salvos em Eventos/ local + perfis.
;   - ARMAZENAMENTO: importar_xmls_pasta agora salva XMLs importados em todos os perfis ativos.
;   - EXE: sys.path guards adicionados em 10 locais sem guarda (fix importação nfe_search no .exe).
;   - EXE: buscar_nfse_auto salva NFS-e em xmls/ local + todos os perfis ativos.
; Notas v1.2.8:
